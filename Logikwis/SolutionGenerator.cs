    ...
    public class SolutionGenerator
    {
        ...
        public static IEnumerable<Solution<Combination<T1, T2>>> Generate<T1, T2>(IReadOnlyCollection<T1> a, IReadOnlyCollection<T2> b)
        {
            ...
            return 
                ...
                select new Solution<Combination<T1, T2>>(Combination<T1, T2>.Zip(a, pB).ToList());
        }
            ...
            IReadOnlyCollection<T2> b, IReadOnlyCollection<T3> c)
        {
            ...
            return
                ...
                select new Solution<Combination<T1, T2, T3>>(Combination<T1, T2, T3>.Zip(a, pB, pC).ToList());
        }
            ...
            IReadOnlyCollection<T2> b, IReadOnlyCollection<T3> c, IReadOnlyCollection<T4> d)
        {
            ...
            return
                ...
                select new Solution<Combination<T1, T2, T3, T4>>(Combination<T1, T2, T3, T4>.Zip(a, pB, pC, pD).ToList());
        }
            ...
            IReadOnlyCollection<T2> b, IReadOnlyCollection<T3> c, IReadOnlyCollection<T4> d, IReadOnlyCollection<T5> e)
        {
            ...
            return
                ...
                select new Solution<Combination<T1, T2, T3, T4, T5>>(Combination<T1, T2, T3, T4, T5>.Zip(a, pB, pC, pD, pE).ToList());
        }
    }
}